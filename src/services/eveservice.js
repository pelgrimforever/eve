...
class Eveservice {
  ...
  static serverurl = 'http://localhost:8080';
	static WEBSERVICE = "/EveWebservices/webresources/";
	static SERVLETWEBSERVICE = "/EveWebservices/";
  ...
  static post = async (restservice, data) => {
    ...
    const urlprefix = Eveservice.test ? Eveservice.cors : '';
    let responsedata = null;
    try {
      const resp = await axios.post(urlprefix + Eveservice.serverurl + Eveservice.WEBSERVICE + restservice, data);
  ...
  static postServlet = async (restservice, data) => {
    ...
    try {
      const resp = await axios({
      	method: 'post',
      	url: urlprefix + Eveservice.serverurl + Eveservice.SERVLETWEBSERVICE + restservice,
      	data: data,
